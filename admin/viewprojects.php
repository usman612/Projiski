	...
	<div class="main-content">
		...
		<table class="table table-striped">
			...
			<tr>
				...
				<td><a href="adminprojectbasechat.php?projectid=<?php echo $project['project_id'];?>&userid=<?php echo $project['user_id'];?>"><button class="btn btn-sm btn-info">communicate<span><i class="entypo-sound"></i></span></button></a></td>
				<td><a href="assignproject.php?projectid=<?php echo $project['project_id'];?>"><button class="btn btn-sm btn-primary">Assign Project<span><i class="entypo-hand"></i></span></button></a></td>
				<td><a href="singleproject.php?projectid=<?php echo $project['project_id'];?>&userid=<?php echo $project['user_id'];?>"><button class="btn btn-sm btn-primary"><i class="entypo-eye"></i>View<span><i class="entypo-hand"></i></span></button></a></td>
				<td><button class="btn btn-sm btn-danger" onclick="delData(<?php echo $project['project_id'];?>)">Delete<span><i class="entypo-trash"></i></span></button></a></td>
			</tr>
			<?php endforeach;?>
		</table>
	</div>
