...
<head>
	...
	<div class="main-content">
		...
		<h2>Single Project Detail <span style="float:right;"><a href="adminprojectbasechat.php?projectid=<?php echo $project['project_id'];?>&userid=<?php echo $_GET['userid'];?>"><button class="btn btn-sm btn-info">communicate<span><i class="entypo-sound"></i></span></button></a></span></h2>
		</br>
		<p id="message">
                              <?php
		...
		<h3><i class="entypo-info"></i>Personal Info <span style="float:right;"><a href="../projects/<?php echo $project['project_file'];?>" target="_blank" download>Download Project Document<a></span></h3>	
		<hr>
		<p><b>Name : </b><span><?php echo $project['fname'];?> <?php echo $project['lname'];?></span></p>
		<p><b>Email : </b><span><?php echo $project['email'];?></span></p>
		<h3><i class="entypo-book"></i>Project Detail</h3>
		<hr>
		<p><b>Project Title : </b><span><?php echo $project['project_about'];?> </span></p>
		<p><b>Project Description : </b><span><?php echo $project['project_description'];?> </span></p>
		<p><b>Budget : </b><span>$<?php echo $project['budget'];?> </span></p>
		<p><b>Date : </b><span><?php echo $project['date'];?> </span></p>
	</div>
