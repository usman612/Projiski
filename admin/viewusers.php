	...
	<div class="main-content">
		...
		<table class="table table-striped">
			...
			<tr>
				...
				<td><a href="communication.php?userid=<?php echo $user['id'];?>"><button class="btn btn-sm btn-info">Communicate<span><i class="entypo-sound"></i></span></button></a></td>
				<td><a href="../viewprofile.php?userid=<?php echo $user['id'];?>" target="_blank"><button class="btn btn-sm btn-primary">View Profile<span><i class="entypo-eye"></i></span></button></a></td>
				
				<td><button class="btn btn-sm btn-danger" onclick="delData(<?php echo $user['id'];?>)">Delete<span><i class="entypo-trash"></i></span></button></a></td>
			</tr>
			<?php endforeach;?>
		</table>
	</div>
