...
{		
	...
	if(isset($_GET['userid']))
	{
		$success = $obj->changePassword($_POST,$_GET['userid']);
		if($success==true)
		{
		...
		{
			$_SESSION['alert1'] = "Old Password is incorrect";
		}
						...
						<form role="form" class="form-horizontal" method="POST" action="" enctype="multipart/form-data">
							...
							<label for="field-1" class="col-sm-3 control-label">Old Password</label>
								...
								<div class="col-md-3 col-sm-6">
									<input type="password" class="form-control" id="field-1" placeholder="********" name="oldpassword"  required>
								</div>
							</div>	
							...
							<label for="field-1" class="col-sm-3 control-label">New Password</label>
								...
								<div class="col-md-3 col-sm-6">
									<input type="password" class="form-control" id="field-1" placeholder="********" name="newpassword" required>
								</div>
							</div>	
