...
$obj= new About;
$abouttext = $obj->getAboutText();
if(isset($_POST['submit']))
{
	if(empty($abouttext))
	{
	$obj->saveAbout($_POST['abouttext']);
	}
	else
	{
		
		$obj->updateAbout($_POST['abouttext']);
	}
...
<div class="page-container"><!-- add class "sidebar-collapsed" to close sidebar by default, "chat-visible" to make chat appear always -->
	<?php include('header.php');?>
		...
		<form role="form" method="post">
			<textarea class="form-control ckeditor" name="abouttext">
				<?php if(!empty($abouttext)){echo $abouttext['abouttext'];}?>
			</textarea><br>
