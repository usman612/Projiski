...
{	
	...
	$add = explode(".", $_FILES['image']['name']);
            ...
            $name = time();
            if (move_uploaded_file($_FILES['image']['tmp_name'], '../images/logo/logo_image' . $name . "." . $add[1])) {

            } else {
                echo "Failed to upload file Contact Site admin to fix the problem";
            }

            $imgName = 'logo_image' . $name . "." . $add[1];	
    }
    else{
    	$imgName = '';
    	}
	
		$update = $obj->updateLogo($imgName);
...
<head>
				...
				<div class="panel panel-primary" data-collapsed="0">
					...
					<div class="panel-body">
						...
						<form role="form" class="form-horizontal" method="POST" action="" enctype="multipart/form-data">
							...
							<label for="field-1" class="col-sm-3 control-label">Points</label>	

    <div class="col-md-4 col-sm-6">
    	<fieldset id="exercises">
        <div class="exercise">
        	<div class="input-group">
           <input type="text" name="points[]" style="width:280px;margin-bottom:5px;" placeholder="points" class="form-control typehead">
        	</div>
        </div>
    </fieldset>
    <button id="add_exercise" class="btn btn-sm btn-info">Add More</button>
</div>
</div> -->
    ...
    $('#exercises').append('<div class="exercise"><div class="input-group"><input type="text" placeholder="points" name="points[]" style="width:260px;margin-bottom:5px;" class="form-control"><button style="height:35px;width:22px;" class="remove">x</button></div></div>');
