                                ...
                                <div class="form_content panel-body clearfix">
                                     <h4>Personal*</h4>
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <select class="form-control" name="position">
                                                <option value="Junior Developer" <?php if($personal['position']=='Junior Developer'){echo 'selected';}?>>Junior Developer</option>
                                                 <option value="Senior Developer" <?php if($personal['position']=='Senior Developer'){echo 'selected';}?>>Senior Developer</option>
                                                  <option value="Junior Designer" <?php if($personal['position']=='Junior Designer'){echo 'selected';}?>>Junior Designer</option>
                                                  <option value="Senior Developer" <?php if($personal['position']=='Senior Designer'){echo 'selected';}?>>Senior Designer</option>
                                            </select>
                                        </div>
                                        <div class="col-lg-6">
                                        ...
                                        <option value="1" <?php if($personal['category']=='1'){echo 'selected';}?>>Websites IT &amp; Software</option>
                                        <option value="2" <?php if($personal['category']=='2'){echo 'selected';}?>>Mobile</option>
                                        <option value="3" <?php if($personal['category']=='3'){echo 'selected';}?>>Writing</option>
                                        <option value="4" <?php if($personal['category']=='4'){echo 'selected';}?>>Design</option>
                                        <option value="5" <?php if($personal['category']=='5'){echo 'selected';}?>>Data Entry</option>
                                        <option value="6" <?php if($personal['category']=='6'){echo 'selected';}?>>Product Sourcing &amp; Manufacturing</option>
                                        <option value="7" <?php if($personal['category']=='7'){echo 'selected';}?>>Sales &amp; Marketing</option>
                                        <option value="8" <?php if($personal['category']=='8'){echo 'selected';}?>>Business, Accounting &amp; Legal</option>
                                        <option value="9" <?php if($personal['category']=='9'){echo 'selected';}?>>Local Jobs &amp; Services</option>
                                    </select>
                                        </div>
                                    </div>
                                    </div>
                                     ...
                                     <div class="form-group">  
                                       ...
                                       <div class="col-lg-6">
                                            ...
                                            <input id="hero-demo" class="form-control" id="passwd" name="skills" type="text" placeholder="HTML,CSS" value="<?php if(!empty($personal['skills'])){echo $personal['skills'];}?>">
                                        </div>
                                    </div>
                                    </div>
                            ...
                            <tbody class="tbodyClone">
                               ...
                               <?php foreach($qualification as $qdata):?> 
                                <tr id="clonedInput1" class="clonedInput">
                                    <td><input id="nm_0" name="qualification_title[]" required type="text" class="form-control" placeholder="Title" value="<?php echo $qdata['q_title'];?>"/></td>
                                    <td><input id="cpf_0" name="year_started[]" required type="text" class="form-control" placeholder="Year Started" value="<?php echo $qdata['q_started'];?>" /></td>
                                    <td><input id="cnh_0" name="year_ended[]" required type="text" class="form-control" placeholder="Year Ended" value="<?php echo $qdata['q_end'];?>" /></td>
                                    <td><input id="passport_0" name="grade[]" required type="text" class="form-control" placeholder="Grade" value="<?php echo $qdata['q_grade'];?>" /></td>
                                    <td>
                            ...
                            <tbody class="tbodyClone2">
                             <?php foreach($experience as $data):?>
                                <tr id="clonedInput2" class="clonedInput2">
                                    <td><input id="nm_1" name="company_name[]" required type="text" class="form-control" placeholder="Company" value="<?php echo $data['company_name'];?>" /></td>
                                    <td><input id="rg_1" name="post_title[]" required type="text" class="form-control" placeholder="Position" value="<?php echo $data['post_title'];?>" /></td>
                                    <td><input id="cpf_1" name="start_date[]" required type="date" class="form-control" placeholder="Starting Date" value="<?php echo $data['e_started'];?>" /></td>
                                    <td><input id="cnh_1" name="end_date[]" required type="date" class="form-control" placeholder="Ending Date" value="<?php echo $data['e_end'];?>" /></td>
                                    <td><input id="passport_1" name="responsibility[]" required type="text" class="form-control" placeholder="Responsibilities" value="<?php echo $data['responsibility'];?>" /></td>
                                    <td>
